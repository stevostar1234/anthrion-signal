...
- Final release-data captures: `artifacts/workspace-layout-release-1484.png`, `artifacts/workspace-layout-release-1132.png`, `artifacts/workspace-layout-release-997.png`, `artifacts/workspace-layout-release-1920.png`, `artifacts/workspace-layout-release-390.png` and `artifacts/workspace-panel-release-390.png`. The release reconciliation adds three genuine source records; the matched visual comparison intentionally retains its earlier fixed dataset.
